...
function twentyten_continue_reading_link() {
	return ' <a href="'. get_permalink() . '">' . __( '<br /> more ', 'twentyten' ) . '</a>';
}
...
register_sidebar ('curriculum'); 

register_sidebar ('blog'); 

register_sidebar ('blog-left'); 
